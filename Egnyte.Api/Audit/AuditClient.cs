namespace Egnyte.Api.Audit
{
    ...
    {
        private const string AuditReportMethod = "/pubapi/v1/audit";
        ...
        private string GetCreateLoginAuditReportContent(
            AuditReportFormat format,
            DateTime startDate,
            DateTime endDate,
            List<string> events,
        ...
        private string MapAuditReportFormat(AuditReportFormat format)
        {
        ...
        private string MapAuditReportAccessPoint(AuditReportAccessPoint accessPoint)
        {
            switch (accessPoint)
            {
        ...
        private string GetCreateFileAuditReportContent(
            AuditReportFormat format,
            DateTime startDate,
            DateTime endDate,
            List<string> folders,
